...
blackjack-double-down = Удвоить ставку
blackjack-split = Разделить
blackjack-surrender = Сдаться
blackjack-take-insurance = Взять страховку
blackjack-decline-insurance = Отказаться от страховки
blackjack-even-money = Взять равные деньги
blackjack-read-hand = Озвучить руку
blackjack-read-dealer = Озвучить дилера
blackjack-table-status = Статус стола
blackjack-read-rules = Озвучить правила
...
blackjack-rule-yes = да
blackjack-rule-no = нет
