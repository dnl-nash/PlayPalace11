...
blackjack-hit = Kér
blackjack-stand = Megáll
blackjack-double-down = Tét duplázása
blackjack-split = Osztás
blackjack-surrender = Feladás
blackjack-take-insurance = Biztosítás kérése
blackjack-decline-insurance = Biztosítás elutasítása
blackjack-even-money = Azonnali kifizetés
blackjack-read-hand = Kéz felolvasása
blackjack-read-dealer = Osztó felolvasása
blackjack-table-status = Asztal állapota
blackjack-read-rules = Szabályok felolvasása
...
blackjack-rule-yes = igen
blackjack-rule-no = nem
