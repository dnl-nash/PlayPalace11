...
blackjack-stand = Stát
blackjack-double-down = Zdvojnásobit sázku
blackjack-split = Rozdělit
blackjack-surrender = Vzdat se
blackjack-take-insurance = Vzít pojištění
blackjack-decline-insurance = Odmítnout pojištění
blackjack-even-money = Vzít jistou výhru
blackjack-read-hand = Přečíst ruku
blackjack-read-dealer = Přečíst dealera
blackjack-table-status = Stav stolu
blackjack-read-rules = Přečíst pravidla
