...
blackjack-hit = कार्ड लो
blackjack-stand = रुको
blackjack-double-down = दांव दोगुना करें
blackjack-split = स्प्लिट करें
blackjack-surrender = सरेंडर करें
blackjack-take-insurance = इंश्योरेंस लें
blackjack-decline-insurance = इंश्योरेंस ठुकराएं
blackjack-even-money = इवन मनी लें
blackjack-read-hand = हाथ पढ़ें
blackjack-read-dealer = डीलर पढ़ें
blackjack-table-status = टेबल स्थिति
blackjack-read-rules = नियम पढ़ें
...
blackjack-rule-yes = हाँ
blackjack-rule-no = नहीं
