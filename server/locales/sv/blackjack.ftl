...
blackjack-hit = Ta kort
blackjack-stand = Stanna
blackjack-double-down = Dubbla insatsen
blackjack-split = Dela
blackjack-surrender = Ge upp
blackjack-take-insurance = Ta försäkring
blackjack-decline-insurance = Avböj försäkring
blackjack-even-money = Ta direkt utbetalning
blackjack-read-hand = Läs hand
blackjack-read-dealer = Läs dealer
blackjack-table-status = Bordsstatus
blackjack-read-rules = Läs regler
