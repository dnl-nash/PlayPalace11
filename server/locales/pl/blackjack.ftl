...
blackjack-hit = Dobierz
blackjack-stand = Pas
blackjack-double-down = Podwój stawkę
blackjack-split = Rozdziel
blackjack-surrender = Poddaj się
blackjack-take-insurance = Weź ubezpieczenie
blackjack-decline-insurance = Odrzuć ubezpieczenie
blackjack-even-money = Weź pewną wypłatę
blackjack-read-hand = Odczytaj rękę
blackjack-read-dealer = Odczytaj krupiera
blackjack-table-status = Status stołu
blackjack-read-rules = Odczytaj zasady
...
blackjack-rule-yes = tak
blackjack-rule-no = nie
