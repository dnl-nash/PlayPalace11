...
blackjack-hit = Vleci
blackjack-stand = Stoj
blackjack-double-down = Podvoji stavo
blackjack-split = Razdeli
blackjack-surrender = Predaj
blackjack-take-insurance = Vzemi zavarovanje
blackjack-decline-insurance = Zavrni zavarovanje
blackjack-even-money = Vzemi takojšnje izplačilo
blackjack-read-hand = Preberi roko
blackjack-read-dealer = Preberi delivca
blackjack-table-status = Stanje mize
blackjack-read-rules = Preberi pravila
