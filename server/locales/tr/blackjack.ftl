...
blackjack-stand = Dur
blackjack-double-down = Bahsi ikiye katla
blackjack-split = Böl
blackjack-surrender = Pes et
blackjack-take-insurance = Sigorta al
blackjack-decline-insurance = Sigortayı reddet
blackjack-even-money = Anında ödeme al
blackjack-read-hand = Eli oku
blackjack-read-dealer = Dağıtıcıyı oku
blackjack-table-status = Masa durumu
blackjack-read-rules = Kuralları oku
...
blackjack-rule-yes = evet
blackjack-rule-no = hayır
