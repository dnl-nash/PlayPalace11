...
blackjack-hit = ヒット
blackjack-stand = スタンド
blackjack-double-down = ダブルダウン
blackjack-split = スプリット
blackjack-surrender = サレンダー
blackjack-take-insurance = インシュランスを取る
blackjack-decline-insurance = インシュランスを断る
blackjack-even-money = イーブンマネーを取る
blackjack-read-hand = 手札を読む
blackjack-read-dealer = ディーラーを読む
blackjack-table-status = テーブル状況
blackjack-read-rules = ルールを読む
...
blackjack-rule-yes = はい
blackjack-rule-no = いいえ
