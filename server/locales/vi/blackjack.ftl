...
blackjack-double-down = Nhân đôi cược
blackjack-split = Tách bài
blackjack-surrender = Đầu hàng
blackjack-take-insurance = Mua bảo hiểm
blackjack-decline-insurance = Từ chối bảo hiểm
blackjack-even-money = Nhận tiền ngang
blackjack-read-hand = Đọc tay bài
blackjack-read-dealer = Đọc tay nhà cái
blackjack-table-status = Trạng thái bàn
blackjack-read-rules = Đọc luật
