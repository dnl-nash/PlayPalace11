...
blackjack-hit = Karte ziehen
blackjack-stand = Halten
blackjack-double-down = Einsatz verdoppeln
blackjack-split = Splitten
blackjack-surrender = Aufgeben
blackjack-take-insurance = Versicherung nehmen
blackjack-decline-insurance = Versicherung ablehnen
blackjack-even-money = Even Money nehmen
blackjack-read-hand = Hand vorlesen
blackjack-read-dealer = Dealer vorlesen
blackjack-table-status = Tischstatus
blackjack-read-rules = Regeln vorlesen
