...
blackjack-hit = Ťahať
blackjack-stand = Stáť
blackjack-double-down = Zdvojnásobiť stávku
blackjack-split = Rozdeliť
blackjack-surrender = Vzdať sa
blackjack-take-insurance = Vziať poistenie
blackjack-decline-insurance = Odmietnuť poistenie
blackjack-even-money = Vziať istú výhru
blackjack-read-hand = Prečítať ruku
blackjack-read-dealer = Prečítať dealera
blackjack-table-status = Stav stola
blackjack-read-rules = Prečítať pravidlá
