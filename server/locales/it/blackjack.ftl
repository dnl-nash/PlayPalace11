...
blackjack-double-down = Raddoppia
blackjack-split = Dividi
blackjack-surrender = Resa
blackjack-take-insurance = Prendi assicurazione
blackjack-decline-insurance = Rifiuta assicurazione
blackjack-even-money = Prendi pagamento immediato
blackjack-read-hand = Leggi mano
blackjack-read-dealer = Leggi banco
blackjack-table-status = Stato tavolo
blackjack-read-rules = Leggi regole
