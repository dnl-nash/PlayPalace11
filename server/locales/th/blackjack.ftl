...
blackjack-hit = จั่ว
blackjack-stand = อยู่
blackjack-double-down = เพิ่มเดิมพันสองเท่า
blackjack-split = แยกไพ่
blackjack-surrender = ยอมแพ้
blackjack-take-insurance = ซื้อประกัน
blackjack-decline-insurance = ปฏิเสธประกัน
blackjack-even-money = รับเงินเท่ากัน
blackjack-read-hand = อ่านไพ่ในมือ
blackjack-read-dealer = อ่านไพ่เจ้ามือ
blackjack-table-status = สถานะโต๊ะ
blackjack-read-rules = อ่านกติกา
...
blackjack-rule-yes = ใช่
blackjack-rule-no = ไม่
