...
blackjack-hit = کارت بگیر
blackjack-stand = ایست
blackjack-double-down = دو برابر کردن شرط
blackjack-split = اسپلیت
blackjack-surrender = تسلیم
blackjack-take-insurance = گرفتن بیمه
blackjack-decline-insurance = رد کردن بیمه
blackjack-even-money = گرفتن پول مساوی
blackjack-read-hand = خواندن دست
blackjack-read-dealer = خواندن دیلر
blackjack-table-status = وضعیت میز
blackjack-read-rules = خواندن قوانین
...
blackjack-rule-yes = بله
blackjack-rule-no = خیر
