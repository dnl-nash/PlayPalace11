...
blackjack-hit = Trage carte
blackjack-stand = Stai
blackjack-double-down = Dublează miza
blackjack-split = Împarte
blackjack-surrender = Renunță
blackjack-take-insurance = Ia asigurare
blackjack-decline-insurance = Refuză asigurarea
blackjack-even-money = Ia plata directă
blackjack-read-hand = Citește mâna
blackjack-read-dealer = Citește dealerul
blackjack-table-status = Starea mesei
blackjack-read-rules = Citește regulile
...
blackjack-rule-yes = da
blackjack-rule-no = nu
