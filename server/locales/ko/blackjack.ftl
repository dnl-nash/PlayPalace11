...
blackjack-hit = 히트
blackjack-stand = 스탠드
blackjack-double-down = 더블다운
blackjack-split = 스플릿
blackjack-surrender = 서렌더
blackjack-take-insurance = 인슈어런스 선택
blackjack-decline-insurance = 인슈어런스 거절
blackjack-even-money = 이븐머니 선택
blackjack-read-hand = 내 패 읽기
blackjack-read-dealer = 딜러 패 읽기
blackjack-table-status = 테이블 상태
blackjack-read-rules = 규칙 읽기
...
blackjack-rule-yes = 예
blackjack-rule-no = 아니요
