...
blackjack-hit = Kaart nemen
blackjack-stand = Passen
blackjack-double-down = Inzet verdubbelen
blackjack-split = Splitsen
blackjack-surrender = Opgeven
blackjack-take-insurance = Verzekering nemen
blackjack-decline-insurance = Verzekering weigeren
blackjack-even-money = Directe uitbetaling nemen
blackjack-read-hand = Hand voorlezen
blackjack-read-dealer = Dealer voorlezen
blackjack-table-status = Tafelstatus
blackjack-read-rules = Regels voorlezen
...
blackjack-rule-yes = ja
blackjack-rule-no = nee
