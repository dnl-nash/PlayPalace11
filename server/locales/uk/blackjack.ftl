...
blackjack-hit = Взяти
blackjack-stand = Стоп
blackjack-double-down = Подвоїти ставку
blackjack-split = Розділити
blackjack-surrender = Здатися
blackjack-take-insurance = Взяти страховку
blackjack-decline-insurance = Відмовитися від страховки
blackjack-even-money = Взяти рівну виплату
blackjack-read-hand = Озвучити руку
blackjack-read-dealer = Озвучити дилера
blackjack-table-status = Стан столу
blackjack-read-rules = Озвучити правила
...
blackjack-rule-yes = так
blackjack-rule-no = ні
