...
blackjack-double-down = Udvostruči ulog
blackjack-split = Podijeli
blackjack-surrender = Predaj se
blackjack-take-insurance = Uzmi osiguranje
blackjack-decline-insurance = Odbij osiguranje
blackjack-even-money = Uzmi sigurnu isplatu
blackjack-read-hand = Pročitaj ruku
blackjack-read-dealer = Pročitaj djelitelja
blackjack-table-status = Stanje stola
blackjack-read-rules = Pročitaj pravila
