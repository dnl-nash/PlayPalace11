...
blackjack-hit = اسحب
blackjack-stand = قف
blackjack-double-down = ضاعف الرهان
blackjack-split = قسّم
blackjack-surrender = استسلم
blackjack-take-insurance = خذ التأمين
blackjack-decline-insurance = ارفض التأمين
blackjack-even-money = خذ الدفع المباشر
blackjack-read-hand = اقرأ اليد
blackjack-read-dealer = اقرأ يد الموزع
blackjack-table-status = حالة الطاولة
blackjack-read-rules = اقرأ القواعد
