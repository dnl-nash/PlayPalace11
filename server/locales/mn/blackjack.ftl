...
blackjack-double-down = Боогоо хоёр дахин нэмэх
blackjack-split = Хуваах
blackjack-surrender = Бууж өгөх
blackjack-take-insurance = Даатгал авах
blackjack-decline-insurance = Даатгалаас татгалзах
blackjack-even-money = Шууд төлбөр авах
blackjack-read-hand = Гараа унших
blackjack-read-dealer = Дилерийн гарыг унших
blackjack-table-status = Ширээний төлөв
blackjack-read-rules = Дүрэм унших
...
blackjack-rule-yes = тийм
blackjack-rule-no = үгүй
