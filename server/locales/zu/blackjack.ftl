...
blackjack-hit = Thatha ikhadi
blackjack-stand = Yima
blackjack-double-down = Phinda kabili ukubheja
blackjack-split = Hlukanisa
blackjack-surrender = Zinikele
blackjack-take-insurance = Thatha umshwalense
blackjack-decline-insurance = Yenqaba umshwalense
blackjack-even-money = Thatha imali eqondile
blackjack-read-hand = Funda isandla
blackjack-read-dealer = Funda umdayisi
blackjack-table-status = Isimo setafula
blackjack-read-rules = Funda imithetho
...
blackjack-rule-yes = yebo
blackjack-rule-no = cha
